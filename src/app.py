...
#     artifact_path='/home/nivetheni/drug-traceability-blockchain/build/contracts/drug.json'
...
#         acc=web3.eth.accounts[0]
#     web3.eth.defaultAccount=acc
#     artifact_path='/home/nivetheni/drug-traceability-blockchain/build/contracts/register.json'
...
# def transfer_eth(from_acc, to_acc, eth_amt):
#     blockchain_address="http://127.0.0.1:8545"
#     web3=Web3(HTTPProvider(blockchain_address))
#     # nonce
...
#     transaction = {
#         'nonce' : nonce,
#         'to' : to_acc, # receiver account address
#         'value': web3.toWei(eth_amt, 'ether'), # eth amount in wei
...
#     # print(walletaddr,mformula,price)
#     contract,web3=connect_Blockchain_drug(walletaddr)
...
#     contract,web3=connect_Blockchain_drug(session['walletaddr'])
#     _lab,_labmanu,_labform,_labprice=contract.functions.viewLabManufacturers().call()
#     data=[]
...
#             dummy.append(_names[manuIndex])
#             # waremIndex=_users.index(_waremtransport[i])
#             dummy.append('CIT Warehouse 1')
#             # transportIndex=_users.index(_transporters[i])
#             dummy.append('CIT Transport')
#             dummy.append('CIT Warehouse 2')
